...
rr = rr+"Click the button to display all Not eligible students ";
...
res.send(rr);
 ...
 app.post('/thank', urlencodedParser, function (req, res){
  ...
  if (err) throw err;
          ...
          var sql ="select * from student where Attendance<80 or CIE<8;";
          
          var sql1 ="delete from student where Attendance<80 or CIE<8;";
          var rr = "<html>";
          rr = rr+"<head>";
          rr = rr+"<style>";
          rr = rr+"table, th, td {";
          ...
          rr = rr+"<h3>Ineligible Students are:</h3>";
          ...
          con.query(sql, function (err, rows,fields) {
              ...
              con1.connect(function(err) {
                if (err) throw err;
              con1.query(sql1, function (err, fields) {
                if (err) 
                    throw err;
